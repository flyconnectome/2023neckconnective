...
fanc_anns = subset(fanc_anns, select = c("class", "dataset","cell_id", "supervoxel_id", "root_id", "group", "side", "type", "synonym", "soma_division", "neuropil", "hemilineage"))
fanc_anns |> arrow::write_feather('../Rint/fanc-neckconnective-anns.feather')
```
