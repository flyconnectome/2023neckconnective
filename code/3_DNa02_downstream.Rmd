...
read the following supplemental sheets 
```{r}
...
```{r}
MANC_FANC_types = data.table::fread(file = '/Users/tomke/Documents/dev/2023neckconnective/Supplemental_files/Supplemental_file13_other_MANC_FANC_matching.tsv')
