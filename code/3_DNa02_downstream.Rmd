...
fig3 <- fig3 %>%
  add_lines(
    x = c(min(dna02dsw_long$L, na.rm = TRUE), max(dna02dsw_long$L, na.rm = TRUE)),
    y = c(min(dna02dsw_long$L, na.rm = TRUE), max(dna02dsw_long$L, na.rm = TRUE)),
...
fig4 <- dna02dsw_dataset |> 
  ...
  add_lines(
    x = c(min(dna02dsw_dataset$weight_manc, na.rm = TRUE), max(dna02dsw_dataset$weight_manc, na.rm = TRUE)),
    y = c(min(dna02dsw_dataset$weight_manc, na.rm = TRUE), max(dna02dsw_dataset$weight_manc, na.rm = TRUE)),
    line = list(dash = "dash", color = "gray"),
    inherit = FALSE,  # Ensures the line is handled separately
    showlegend = FALSE
  ) %>%
...
fig5 <- dna02dsw_dataset |> 
  ...
  add_lines(
    x = c(min(dna02dsw_dataset$weightP_manc, na.rm = TRUE), max(dna02dsw_dataset$weightP_manc, na.rm = TRUE)),
    y = c(min(dna02dsw_dataset$weightP_manc, na.rm = TRUE), max(dna02dsw_dataset$weightP_manc, na.rm = TRUE)),
    line = list(dash = "dash", color = "gray"),
    inherit = FALSE,  # Ensures the line is handled separately
    showlegend = FALSE
  ) %>%
